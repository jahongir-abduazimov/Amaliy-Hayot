...
export default function Footer() {
  ...
  const socialLinks = [
    ...
    {
      name: "Facebook",
      href: "https://www.facebook.com/amaliyhayot",
      icon: (
        <svg
          className="w-5 h-5"
          fill="currentColor"
          ...
          <div className="space-y-4">
            <Link href="/" className="flex items-center gap-3">
              <Image
                ...
                height={56}
              />
              <span className="text-lg md:text-3xl font-bold text-primary">
                Amaliy Hayot
              </span>
            </Link>
            <p className="text-sm md:text-base text-neutral-text-gray leading-relaxed">
              O‘zbekistonda kundalik hayotga oid foydali ma’lumotlar,
              yo‘riqnomalar va maslahatlar.
            </p>
          </div>
