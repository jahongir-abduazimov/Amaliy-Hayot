...
export default function MobileTelegramBar() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 md:hidden">
      <div className="relative mx-3 mb-4 rounded-3xl bg-ocean-gradient text-white shadow-2xl shadow-blue border border-white/40 px-4 pt-4 pb-4 flex flex-col gap-3 animate-slide-up">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1 space-y-1">
            <p className="font-medium text-[15px] leading-snug">
              ...
              qo‘llanmalar va maslahatlar berib boriladi. Kerakli paytda qidirib
              qolmaslik uchun hoziroq obuna bo‘lib qo‘ying — albatta
              foydali bo‘ladi 😉
            </p>
        ...
        <div className="flex items-center justify-between gap-3 mt-1">
          ...
          <Link
            ...
            className="px-4 py-2.5 rounded-2xl bg-white text-primary text-[13px] font-extrabold shadow-lg shadow-blue/60 hover:bg-gray-100 smooth whitespace-nowrap cursor-pointer flex items-center gap-1.5 animate-pulse-soft"
          >
            <svg
