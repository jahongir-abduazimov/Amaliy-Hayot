    ...
    <div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-neutral-text-gray mb-8 sm:mb-10 leading-relaxed px-2">
              Kundalik hayot haqida foydali ma’lumotlar - barchasi bir joyda
            </p>

            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mb-12 sm:mb-16">
              <a
                href="#maqolalar"
                className="group bg-primary text-white px-6 py-3 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-xl text-base sm:text-lg font-bold shadow-blue hover:bg-[#0369A1] smooth inline-flex items-center justify-center cursor-pointer"
              >
                Maqolalarni o‘qish
            ...
            {/* <div className="flex flex-wrap items-center justify-center gap-8 text-sm text-neutral-text-light">
              <span className="flex items-center gap-2">
                <span className="text-primary">✓</span> 500+ Maqolalar
              </span>
              <span className="flex items-center gap-2">
                <span className="text-primary">✓</span> 50K+ O'quvchilar
              </span>
              <span className="flex items-center gap-2">
                <span className="text-primary">✓</span> Bepul
              </span>
            </div> */}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="max-w-3xl mx-auto">
            <p className="text-sm text-neutral-text-gray leading-relaxed">
              ...
              hayot uchun amaliy yo‘riqnomalarni taqdim etadi: davlat
              xizmatlari, hujjatlar, jarimalar, sog‘liqni saqlash va moliyaviy
              ma’lumotlar.
            </p>
          </div>
        </div>
      ...
      {posts.length > 0 && (
        <section id="maqolalar" className="bg-white py-10 md:py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-neutral-text-dark mb-6 md:mb-8">
              So‘nggi Maqolalar
            </h2>
            ...
            {posts.length > 6 && (
              <div className="text-center mt-12">
                <Link
                  href="/blog"
                  className="inline-flex items-center text-primary font-semibold hover:text-[#0369A1] smooth"
                >
