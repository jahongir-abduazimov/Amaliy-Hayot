export const metadata = {
  title: "Bog‘lanish",
  description:
    "Amaliy Hayot bilan bog‘laning. Savollar, takliflar yoki fikr-mulohazalar uchun bizga murojaat qiling.",
    ...
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-30">
      ...
      <div className="text-center mb-12 md:mb-16 relative">
        ...
        <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
          Savollar, takliflar yoki fikr-mulohazalaringiz bo‘lsa, bizga murojaat
          qiling. Biz har doim o‘quvchilarimizdan fikr-mulohazalarni kutib
          qolamiz!
        </p>
      </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700">
                Biz Telegram orqali murojaat qilganlarga <strong>darhol</strong>{" "}
                javob berishga harakat qilamiz. Facebook orqali murojaat
                qilganlarga esa <strong>24 soat ichida</strong> javob beramiz.
              </p>
            </div>
          </div>
        </div>
